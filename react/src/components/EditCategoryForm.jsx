...
export default function EditCategoryForm({ categoryId, handleClose, isLoading, setIsLoading, refreshCategories }) {
    ...
    const formik = useFormik({
        ...
        onSubmit: (values, { resetForm }) => {
            editCategory(categoryId, values.name, setIsLoading, refreshCategories, handleClose, showSnackbar);
        },
    });
    ...
    return(
        <Stack className='AddCategoryForm' component='form' onSubmit={formik.handleSubmit}>
            ...
            >
                <Stack direction='row'>
                    <Typography variant='caption' sx={{ whiteSpace: 'nowrap' }}>Change name</Typography>
